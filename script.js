...
async function handleImageLoad(url, prompt, size, imageContainerCard1, imageContainerCard2, loadingSpinnerCard1) {  
    ...
    imgCard1.onload = async () => {  
        ...
        imgCard2.onerror = () => handleImageError(imageContainerCard1, loadingSpinnerCard1);  
    ...
    imgCard1.onerror = () => handleImageError(imageContainerCard1, loadingSpinnerCard1);  
}  
...
leftArrowButtonCard3.addEventListener('click', () => {  
    if (appState.card3Images.length > 0) {  
        appState.currentCard3ImageIndex = (appState.currentCard3ImageIndex - 1 + appState.card3Images.length) % appState.card3Images.length;  
...
rightArrowButtonCard3.addEventListener('click', () => {  
    if (appState.card3Images.length > 0) {  
        appState.currentCard3ImageIndex = (appState.currentCard3ImageIndex + 1) % appState.card3Images.length;  
        displayCard3Image(appState.currentCard3ImageIndex);  
    }  
});  
...
downloadButtonCard3.addEventListener('click', () => {  
    if (appState.card3Images.length > 0 && appState.currentCard3ImageIndex >= 0 && appState.currentCard3ImageIndex < appState.card3Images.length) {  
        const link = document.createElement('a');  
...
deleteButtonCard3.addEventListener('click', () => {  
    if (appState.card3Images.length > 0 && appState.currentCard3ImageIndex >= 0 && appState.currentCard3ImageIndex < appState.card3Images.length) {  
        ...
        appState.currentCard3ImageIndex = Math.min(appState.currentCard3ImageIndex, appState.card3Images.length - 1);  
        displayCard3Image(appState.currentCard3ImageIndex);  
    } else {  
